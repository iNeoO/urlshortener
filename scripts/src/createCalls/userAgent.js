...
exports.generateRandomUserAgent = void 0;
var USER_AGENT_PROFILES = [
    // Chrome desktop
...
var generateRandomUserAgent = function () {
    var index = Math.floor(Math.random() * USER_AGENT_PROFILES.length);
